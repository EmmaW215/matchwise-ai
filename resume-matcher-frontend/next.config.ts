        ...
        headers: [
          {
            ...
            // 'self' - 允许同源嵌入
            // https://smart-success-ai.vercel.app - SmartSuccess.AI 生产环境
            ...
            value: "frame-ancestors 'self' https://smart-success-ai.vercel.app https://*.vercel.app http://localhost:* http://127.0.0.1:* http://192.168.86.46:*;",
          },
        ],
      },
    ];
